...
export default function LandingClient({ isLoggedIn }: Props) {
  ...
  // CTAs que cambian según estado de sesion
  const primaryHref = isLoggedIn ? "/dashboard" : "/register";
  const primaryLabel = isLoggedIn ? "Ir al dashboard" : "Empezar gratis";
  const navAuthHref = isLoggedIn ? "/dashboard" : "/login";
  const navAuthLabel = isLoggedIn ? "Mi dashboard" : "Ingresar";
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-4">
              <Link
                href={navAuthHref}
                style={{ fontSize: "0.875rem", fontWeight: 500, color: "#7A6A52", textDecoration: "none" }}
              >
                {navAuthLabel}
              </Link>
            </div>
      ...
      <main>
        ...
        <section style={{ padding: "5rem 1.5rem 6rem" }}>
          <div className="mx-auto max-w-4xl text-center">
            <div
              style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", backgroundColor: "#faedcd", border: "1px solid #E8DECE", borderRadius: "999px", padding: "0.25rem 0.875rem", fontSize: "0.8125rem", fontWeight: 600, color: "#7A6A52", marginBottom: "2rem" }}
            >
            ...
            <h1
              style={{ fontFamily: "var(--font-playfair), serif", fontSize: "clamp(2.5rem, 6vw, 3.75rem)", fontWeight: 700, lineHeight: 1.15, color: "#2C2416", marginBottom: "1.5rem" }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href={primaryHref}
                style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", backgroundColor: "#d4a373", color: "#ffffff", fontWeight: 600, fontSize: "0.9375rem", padding: "0.75rem 2rem", borderRadius: "8px", textDecoration: "none", transition: "background-color 150ms" }}
              ...
              <div style={{ display: "flex", height: 260 }}>
                <div style={{ width: 160, backgroundColor: "#e9edc9", borderRight: "1px solid #E8DECE", padding: "1rem 0.75rem", display: "flex", flexDirection: "column", gap: "0.5rem" }} className="hidden sm:flex">
                  ...
                  {["#d4a373", "#7CAE7A", "#6B9AB8", "#E07B54"].map((c, i) => (
                    <div key={i} style={{ height: 30, backgroundColor: i === 0 ? "#fefae0" : "transparent", borderRadius: 6, display: "flex", alignItems: "center", padding: "0 0.5rem", gap: "0.5rem" }}>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {FEATURES.map(({ icon: Icon, title, desc, bg, dot }) => (
                ...
                >
                  <div style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: "rgba(255,255,255,0.55)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem", color: dot }}>
                    <Icon size={18} />
                  </div>
        ...
        <section style={{ backgroundColor: "#faedcd", padding: "5rem 1.5rem", borderTop: "1px solid #E8DECE" }}>
          <div className="mx-auto max-w-2xl text-center">
            <h2 style={{ fontFamily: "var(--font-playfair), serif", fontSize: "clamp(1.75rem, 4vw, 2.25rem)", fontWeight: 700, color: "#2C2416", marginBottom: "1rem" }}>
            ...
            <Link
              href={primaryHref}
              style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", backgroundColor: "#d4a373", color: "#ffffff", fontWeight: 600, fontSize: "0.9375rem", padding: "0.75rem 2.25rem", borderRadius: "8px", textDecoration: "none", transition: "background-color 150ms" }}
              onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#C4915F")}
              onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#d4a373")}
            >
              {primaryLabel}
